# ToolSearch Agent Skills and Prompt Indexing Progress Report

ToolSearch now supports indexing and semantic discovery of **Agent Skills** and **MCP Prompts**, alongside tools.
...
5.  **New Search Tools**:
    *   Added `toolsearch_find_prompts` and `toolsearch_find_skills` to the search server.
