# ToolSearch Enhancement Report

The ToolSearch library has been upgraded with a production-ready HTTP/SSE server and shared core logic.

## Enhancements
1.  **FastAPI Server**: Added `tool-search server` command.
...
2.  **Shared Search Core**: Refactored `src/toolsearch/retrieval/core.py` to share semantic filtering logic between the stdio Proxy and the HTTP Server.
