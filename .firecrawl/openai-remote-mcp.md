...
| --- | --- | --- |
| [Responses](https://developers.openai.com/api/docs/api-reference/responses)<br>[Chat Completions](https://developers.openai.com/api/docs/api-reference/chat)<br>[Assistants](https://developers.openai.com/api/docs/api-reference/assistants) | **Tier 1**<br>200 RPM<br>**Tier 2 and 3**<br>1000 RPM<br>**Tier 4 and 5**<br>2000 RPM | [Pricing](https://developers.openai.com/api/docs/pricing#built-in-tools)<br>[ZDR and data residency](https://developers.openai.com/api/docs/guides/your-data) |